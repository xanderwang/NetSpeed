...
public class NetSpeedService extends Service {
    ...
    private static String TAG = "NetSpeedService";

    private OverFlowWindows mOverFlowWindows;
    ...
    public static NetSpeedService instance() {
        return mService;
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (UPDATE_NET_DATA == msg.what) {
                ...
                //mOverFlowWindows.mSpeed.setText(speedFmt);
                //showNtfSpeed( (int)(speed / (1024 * 1024 * mFrequency)) );
                if (mStyle == STYLE_NTF) {
                    showNtfSpeed((int) speed, speedFmt);
                } else {
                    mOverFlowWindows.updateSpeed(speedFmt);
                }
            }
        }
    };
    ...
    public void showNtfSpeed(int speed, String speedFmt) {
        NetSpeedNotification.showNotifacation(this, speed, speedFmt);
    }
    ...
    private void initData() {
        mOverFlowWindows = new OverFlowWindows(this);
        mStyle = getPreferences(this, KEY_STYLE, STYLE_NTF);
        if (STYLE_NTF == mStyle) {
            mOverFlowWindows.removeFromWindow();
        } else if (STYLE_OVER == mStyle) {
            mOverFlowWindows.addToWindow();
        }
    ...
    public void updateStyle(int style) {
        ...
        if (STYLE_NTF == style) {
            ...
            mOverFlowWindows.addToWindow();
            NetSpeedNotification.cancelNtf(this);
        }
    }
